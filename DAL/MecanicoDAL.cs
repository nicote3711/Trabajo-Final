    ...
    public class MecanicoDAL
    {
        ...
        public void AltaMecanico(Mecanico mecanico)
        {
            try
            {
                ...
                var tablaPersonas = ds.Tables["Persona"];
                var tablaMecanicos = ds.Tables["Mecanico"];
                var tablaRelaciones = ds.Tables["Tipo_Mantenimiento_Mecanico"];
                ...
                var rowPersonaExistente = tablaPersonas.AsEnumerable().FirstOrDefault(p => p.Field<long>("Dni") == mecanico.DNI);
