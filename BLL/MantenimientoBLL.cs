	...
	public class MantenimientoBLL
	{
		...
		public void ValidarCondicionesAlta(Mantenimiento mantenimiento)
		{
            try
            {
                ...
                //Vale la pena hacer un metodo en DAL( equivalente a una query)? ya puedo sacar el filtrado por Id aeronave ahora que no busco todos se puede usar any
                ...
                switch ((EnumTipoMantenimiento)mantenimiento.TipoMantenimiento.IdTipoMantenimiento)
                {
                    ...
                    case EnumTipoMantenimiento.Anual:
                        if (mantenimiento.Aeronave.RevisionAnual.Date >= DateTime.Now.Date)
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("BLL Mantenimiento error al validar condiciones de alta: "+ex.Message,ex);
            }
        ...
        public void RegistrarFacturaMant(Mantenimiento mantenimiento)
        {
            ...
            try
            {
                ...
                mantenimiento.Aeronave.Estado = estadoAeronave;
