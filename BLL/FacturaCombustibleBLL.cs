    ...
    public class FacturaCombustibleBLL
    {
        ...
        public void EliminarFactura(FacturaCombustible facturaCombustible)
        {
			...
			try
			{
				...
				Resultado result = HelperFacturas.EliminarFacturaPDF((int)EnumTiposFactura.FacturaRecargaCombustible, facturaCombustible.NroFactura,facturaCombustible.CuilEmisor); // no lanzo la exception aca porque no es necesario para el esquema como esta ahora.
