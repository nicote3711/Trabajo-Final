    ...
    public class FacturaMantenimientoBLL
    {
        ...
        public void EliminarFacturaMantenimiento(FacturaMantenimiento facturaMantenimiento)
        {
            ...
            try
            {
               ...
               Resultado resultado = HelperFacturas.EliminarFacturaPDF((int)EnumTiposFactura.FacturaMantenimiento, facturaMantenimiento.NroFactura, facturaMantenimiento.CuilEmisor);
