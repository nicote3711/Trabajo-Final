    ...
    public class SolicitudHorasBLL
    {
		...
		public void EliminarSolicitudHoras(SolicitudHoras solicitudHoras)
		{
            ...
            try
			{
                ...
                Resultado result = HelperFacturas.EliminarFacturaPDF((int)EnumTiposFactura.FacturaSolicitudHoras, solicitudHoras.Factura.NroFactura, solicitudHoras.Factura.CuilEmisor);
